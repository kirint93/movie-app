export interface IMovie {
  ...
  export const forrestGump: IMovie = {
    title: 'Forrest Gump',
    year: '1994',
  ...
  export const Nightcrawler: IMovie = {
    title: 'Nightcrawler',
    year: '2014',
  ...
  export const immitationGame: IMovie = {
  ...
  export const Intouchables: IMovie = {
  ...
  export const theMartian: IMovie = {
    title: 'The Martian',
    year: '2015',
  ...
  export const shutterIsland: IMovie = {
  ...
  export const movieArray = [shutterIsland, Insideout, toyStory, aboutTime, forrestGump, Nightcrawler, theHelp, immitationGame,  Big, Intouchables, dieHard, goneGirl]